...
from src.basic_model.model_architecture.sub_layer.cnn_feature_extract import CNNFeatureExtract1D
from src.basic_model.model_architecture.sub_layer.layer_highway import Highway
from torch.nn.utils.rnn import pad_packed_sequence, pack_padded_sequence

#Mô hình LSTMWordCnnCharEncoder là một mô hình mạng nơ-ron sử dụng để mã hóa thông tin từ các từ và ký tự trong các câu hoặc văn bản
#Cuối cùng, đầu ra của mô hình là biểu diễn cuối cùng của các câu hoặc văn bản sau khi đã mã hóa thông tin từ và ký tự
