...
#Cả hai mô-đun này được thiết kế để trích xuất các đặc trưng quan trọng từ dữ liệu đầu vào bằng cách sử dụng các lớp tích
# chập và sau đó nối lại các đặc trưng được thu thập từ các kích thước kernel khác nhau.
